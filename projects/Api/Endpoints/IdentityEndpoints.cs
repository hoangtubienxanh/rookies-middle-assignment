...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapIdentityEndpoint<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            if (!userManager.SupportsUserEmail)
            {
                throw new NotSupportedException(
                    $"{nameof(MapIdentityEndpoint)} requires a user store with email support.");
            }
        ...
        routeGroup.MapGet("/confirmEmail", async Task<Results<ContentHttpResult, UnauthorizedHttpResult>>
            ...
            .Add(endpointBuilder =>
            {
                ...
                confirmEmailEndpointName = $"{nameof(MapIdentityEndpoint)}-{finalPattern}";
